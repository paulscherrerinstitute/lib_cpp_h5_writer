...
int main (int argc, char *argv[])
{
    ...
    auto header_values = shared_ptr<unordered_map<string, HeaderDataType>>(new unordered_map<string, HeaderDataType> {
        ...
        {"pulse_id_diff", HeaderDataType("int64", 6)},
        {"framenum_diff", HeaderDataType("int64", 6)},

        {"missing_packets_1", HeaderDataType("uint64", 6)},
        {"missing_packets_2", HeaderDataType("uint64", 6)},
        {"daq_recs", HeaderDataType("uint64", 6)},
        
        {"pulse_ids", HeaderDataType("uint64", 6)},
        {"framenums", HeaderDataType("uint64", 6)},
        
        {"module_number", HeaderDataType("uint64", 6)}
    });

...
int main (int argc, char *argv[])
{
    ...
    auto header_values = shared_ptr<unordered_map<string, HeaderDataType>>(new unordered_map<string, HeaderDataType> {
        ...
        {"pulse_id_diff", HeaderDataType("int64", 9)},
        {"framenum_diff", HeaderDataType("int64", 9)},

        {"missing_packets_1", HeaderDataType("uint64", 9)},
        {"missing_packets_2", HeaderDataType("uint64", 9)},
        {"daq_recs", HeaderDataType("uint64", 9)},
        
        {"pulse_ids", HeaderDataType("uint64", 9)},
        {"framenums", HeaderDataType("uint64", 9)},
        
        {"module_number", HeaderDataType("uint64", 9)}
    });

...
h5_group get_format(){
    ...
    h5_group("entry", {
        ...
        h5_group("control", {
            h5_attr("NX_class", "NXmonitor", NX_CHAR),

            h5_dataset("mode", "control/mode", NX_CHAR, {
                h5_attr("NX_class", "NX_CHAR", NX_CHAR)
            }),
            h5_dataset("note", "control/note", NXnote, {
                h5_attr("NX_class", "NXnote", NX_CHAR)
            }),
            h5_dataset("integral", "control/integral", NX_FLOAT, {
                h5_attr("NX_class", "NX_FLOAT", NX_CHAR)
            })
        }),

        h5_group("instrument", {
            h5_attr("NX_class", "NXinstrument", NX_CHAR),
            ...
            h5_group("insertion_device", {
                h5_attr("NX_class", "NXinsertion_device", NX_CHAR),

                h5_dataset("gap", "insertion_device/gap", NX_FLOAT, {
                    h5_attr("NX_class", "NX_FLOAT", NX_CHAR),
                    h5_attr("NX_LENGTH", "mm", NX_CHAR)
                }),
                h5_dataset("k", "insertion_device/k", NX_FLOAT, {
                    h5_attr("NX_class", "NX_FLOAT", NX_CHAR),
                    h5_attr("NX_DIMENSIONLESS", "True", NX_CHAR)
                }),
                h5_dataset("harmonic", "insertion_device/harmonic", NX_INT, {
                    h5_attr("NX_UNITLESS", "true", NX_CHAR),
                    h5_attr("NX_class", "NX_INT", NX_CHAR)
                }),
            ...
            h5_group("XBPM5", {
                h5_attr("NX_class", "NXdetector_group", NX_CHAR),
                ...
                h5_group("XBPM5_x", {
                    h5_attr("NX_class", "NX_detector", NX_CHAR),
                ...
                h5_group("XBPM5", {
                    ...
                    h5_dataset("count_time", "XBPM5/count_time", NX_NUMBER, {
                        h5_attr("NX_class", "NX_NUMBER", NX_CHAR),
                        h5_attr("NX_TIME", "s", NX_CHAR)
                    }),
            ...
            h5_group("beam_stop_2", {
                h5_attr("NX_class", "NX_beamstop", NX_CHAR),
            ...
            h5_group("filter_set", {
                h5_attr("NX_class", "NXattenuator", NX_CHAR),
            ...
            h5_group("slit_4", {
                h5_attr("NX_class", "NXslit", NX_CHAR),
            ...
            h5_group("source", {
                h5_attr("NX_class", "NXsource", NX_CHAR),

                h5_dataset("divergence_y", "source/divergence_y", NX_FLOAT, {
                    h5_attr("NX_class", "NX_FLOAT", NX_CHAR),
                    h5_attr("NX_ANGLE", "radians", NX_CHAR)
                }),
            ...
            h5_group("mirror", {
                h5_attr("NX_class", "NXmirror", NX_CHAR),
            ...
            h5_group("monochromator", {
                h5_attr("NX_class", "NXmonochromator", NX_CHAR),

                h5_dataset("wavelength", "monochromator/wavelength", NX_FLOAT, {
                    h5_attr("NX_WAVELENGTH", "Angstrom", NX_CHAR),
                    h5_attr("NX_class", "NX_FLOAT", NX_CHAR)
                }),
                ...
                h5_group("crystal_2", {
                    h5_attr("NX_class", "NXcrystal", NX_CHAR),
        ...
        h5_group("plottable_data", {
            h5_attr("NX_class", "NXdata", NX_CHAR),


        }),

        h5_group("sample", {
            h5_attr("NX_class", "NXsample", NX_CHAR),

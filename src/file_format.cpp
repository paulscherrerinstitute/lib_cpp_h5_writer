...
h5_group get_format(){
    ...
    h5_group("entry", {
        ...
        h5_group("control", {
            h5_attribute_val<NX_CHAR>("NX_class", "NXmonitor"),

            h5_dataset("integral", "control/integral", NX_FLOAT, {
                h5_attribute_val<NX_CHAR>("NX_class", "NX_FLOAT")
            }),
            h5_dataset("mode", "control/mode", NX_CHAR, {
                h5_attribute_val<NX_CHAR>("NX_class", "NX_CHAR")
            }),
            h5_dataset("note", "control/note", NXnote, {
                h5_attribute_val<NX_CHAR>("NX_class", "NXnote")
            })
        }),

        h5_group("plottable_data", {
            h5_attribute_val<NX_CHAR>("NX_class", "NXdata")
        }),

        h5_group("sample", {
            h5_attribute_val<NX_CHAR>("NX_class", "NXsample"),

            h5_dataset("aequatorial_angle", "sample/aequatorial_angle", NX_FLOAT, {
                h5_attribute_val<NX_CHAR>("NX_class", "NX_FLOAT"),
                h5_attribute_val<NX_CHAR>("NX_ANGLE", "deg")
            }),
            ...
            h5_dataset("y_translation", "sample/y_translation", NX_FLOAT, {
                h5_attribute_val<NX_CHAR>("NX_class", "NX_FLOAT"),
                h5_attribute_val<NX_CHAR>("NX_LENGTH", "mm")
            }),
        ...
        h5_group("instrument", {
            h5_attribute_val<NX_CHAR>("NX_class", "NXinstrument"),
            ...
            h5_group("slit_3", {
                h5_attribute_val<NX_CHAR>("NX_class", "NXslit"),
            ...
            h5_group("beam_stop_2", {
                h5_attribute_val<NX_CHAR>("NX_class", "NX_beamstop"),
            ...
            h5_group("mirror", {
                h5_attribute_val<NX_CHAR>("NX_class", "NXmirror"),

                h5_dataset("bend_y", "mirror/bend_y", NX_FLOAT, {
                    h5_attribute_val<NX_CHAR>("NX_class", "NX_FLOAT"),
                    h5_attribute_val<NX_CHAR>("NX_ANY", "")
                }),
                h5_dataset("incident_angle", "mirror/incident_angle", NX_FLOAT, {
                    h5_attribute_val<NX_CHAR>("NX_class", "NX_FLOAT"),
                    h5_attribute_val<NX_CHAR>("NX_ANGLE", "degrees")
                }),
            ...
            h5_group("XBPM5", {
                h5_attribute_val<NX_CHAR>("NX_class", "NXdetector_group"),

                h5_dataset("group_parent", "XBPM5/group_parent", NX_INT, {
                    h5_attribute_val<NX_CHAR>("NX_class", "NX_INT")
                }),
                ...
                h5_group("XBPM5_y", {
                    h5_attribute_val<NX_CHAR>("NX_class", "NX_detector"),
                ...
                h5_group("XBPM5", {
                    ...
                    h5_dataset("count_time", "XBPM5/count_time", NX_NUMBER, {
                        h5_attribute_val<NX_CHAR>("NX_class", "NX_NUMBER"),
                        h5_attribute_val<NX_CHAR>("NX_TIME", "s")
                    }),
            ...
            h5_group("filter_set", {
                h5_attribute_val<NX_CHAR>("NX_class", "NXattenuator"),
            ...
            h5_group("insertion_device", {
                h5_attribute_val<NX_CHAR>("NX_class", "NXinsertion_device"),

                h5_dataset("k", "insertion_device/k", NX_FLOAT, {
                    h5_attribute_val<NX_CHAR>("NX_class", "NX_FLOAT"),
                    h5_attribute_val<NX_CHAR>("NX_DIMENSIONLESS", "True")
                }),
                ...
                h5_dataset("harmonic", "insertion_device/harmonic", NX_INT, {
                    h5_attribute_val<NX_CHAR>("NX_UNITLESS", "true"),
                    h5_attribute_val<NX_CHAR>("NX_class", "NX_INT")
                }),
            ...
            h5_group("monochromator", {
                h5_attribute_val<NX_CHAR>("NX_class", "NXmonochromator"),
                ...
                h5_dataset("wavelength", "monochromator/wavelength", NX_FLOAT, {
                    h5_attribute_val<NX_CHAR>("NX_class", "NX_FLOAT"),
                    h5_attribute_val<NX_CHAR>("NX_WAVELENGTH", "Angstrom")
                }),
                ...
                h5_dataset("energy", "monochromator/energy", NX_FLOAT, {
                    h5_attribute_val<NX_CHAR>("NX_ENERGY", "keV"),
                    h5_attribute_val<NX_CHAR>("NX_class", "NX_FLOAT")
                }),

                h5_group("crystal_1", {
                    h5_attribute_val<NX_CHAR>("NX_class", "NXcrystal"),
                    ...
                    h5_dataset("reflection", "crystal_1/reflection", NX_INT, {
                        h5_attribute_val<NX_CHAR>("NX_class", "NX_INT"),
                        h5_attribute_val<NX_CHAR>("NX_UNITLESS", "")
                    }),
            ...
            h5_group("source", {
                h5_attribute_val<NX_CHAR>("NX_class", "NXsource"),
                ...
                h5_dataset("current", "source/current", NX_FLOAT, {
                    h5_attribute_val<NX_CHAR>("NX_CURRENT", "mA"),
                    h5_attribute_val<NX_CHAR>("NX_class", "NX_FLOAT")
                }),
                ...
                h5_dataset("divergence_x", "source/divergence_x", NX_FLOAT, {
                    h5_attribute_val<NX_CHAR>("NX_ANGLE", "radians"),
                    h5_attribute_val<NX_CHAR>("NX_class", "NX_FLOAT")
                }),
